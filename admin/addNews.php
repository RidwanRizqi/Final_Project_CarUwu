...
$query = mysqli_query($koneksi, "SELECT max(id_berita) as idBeritaTerbesar FROM berita");
$data = mysqli_fetch_array($query);
$idBerita = $data['idBeritaTerbesar'];
$urutan = $idBerita;
$urutan++;
$idBerita = $urutan;

if (isset($_POST['tambah'])) {
//    $idMobil = $_POST['idBerita'];
    ...
    $query = "INSERT INTO berita VALUES 
                      ('$idBerita', '$judulBerita', '$subjudulBerita', '$tanggalBerita', '$isiBerita', '$gambarBerita')";
            ...
            <form method="post" action="" enctype="multipart/form-data" class="row g-3">
                <div class="mb-3 col-md-2">
                    ...
                    <input required type="text" name="idBerita" class="form-control" id="idBerita"
                           placeholder="MBLxxx" value="<?php echo $idBerita ?>" disabled>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input required class="date form-control" type="text" data-name="tanggalBerita" name="tanggalBerita">
                </div>
